...
Console.Clear();
Console.WriteLine("--- Um dia no Complexo Alfa ---");
Console.WriteLine("Aventura-solo baseada no RPG Paranoia\n");
Console.WriteLine("Você está feliz, cidadão?");

Console.WriteLine("\nPara sair vá para 99 a qualquer momento.\n");
Console.Write("Pressione uma tecla para começar...");
Console.ReadKey();

int indiceEntradaAtual = 0;
while (indiceEntradaAtual >= 0 && indiceEntradaAtual <= 40)
{
    Console.Clear();

    Entrada entradaAtual = aventura[indiceEntradaAtual];
    ...
    } while (!entradaAtual.Alternativas.Contains(indiceDesejado) && indiceDesejado != 99);
